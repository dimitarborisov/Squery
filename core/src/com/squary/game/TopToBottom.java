...
public class TopToBottom extends GameState{
	...
	public TopToBottom(GameStateManager m, GameState from, GameState to, boolean flipX, boolean flipY) {
		super(m);
		...
		Tween.to(previousSprite, TweenEngineSprite.POS_XY, 0.8f).target(0, previousSprite.getHeight()).delay(0.2f)
				// .ease(TweenEquations.easeOutBack)
				.start(tweenManager);
	}
